...
//        System.out.println("");
        ...
        for (numOfTries = 1; numOfTries < 6; numOfTries++) {
            ...
            if (numberOfChecking == result) {
                System.out.println("Congratulations! you guessed the number!  it took you " + numOfTries + " tries to guess the right number!");
                System.out.println("Game Over, You Won");
                break;

            } else if (numberOfChecking < low || numberOfChecking > high) {
                System.out.println("Remember that the guessing range is between " + low + " through " + high);
